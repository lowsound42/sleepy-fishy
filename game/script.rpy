...
define gd = Character('Mr. Gillyweed', color="#228822")
define sm = Character('Mrs. Saltwater', color="#228822")
define b = Character('Gillbert', color="#28a510")
define s = Character('Sally', color="#555b57")
...
define r = Character('Ramsea', color = "#1d6bd1")
